            ...
            <div class="card-container">
              ...
              <div class="center-container">
                ...
                <div class="center-right">
                  ...
                  <div class="text-one-line">
                    <div>
                      <p>Ngày sinh: {{ listData.dob || 'Chưa có dữ liệu' }}</p>
                    </div>
                    <div>
                      <p>Giới tính: {{ listData.gender || 'Chưa có dữ liệu' }}</p>
                    </div>
                  </div>
                  <div class="text-one-line">
                    <p>Nơi DK KCB BĐ:</p>
                    <p>{{ listData.ihos || 'Chưa có dữ liệu' }}</p>
                  </div>
                  <div class="text-one-line">
                    <p>Giá trị sử dụng: đến ngày {{ listData.expire_date || 'Chưa có dữ liệu' }}</p>
                  </div>
                  <div class="text-one-line">
                    <p>
                      Thời điểm đủ 05 năm liên tục: từ ngày
                      {{ listData.issue_date || 'Chưa có dữ liệu' }}
                    </p>
                  </div>
                  <div class="text-one-line">
                    <p>Nơi cấp: {{ listData.iplace || 'Chưa có dữ liệu' }}</p>
                  </div>
                </div>
              </div>
            </div>
